...
ValuationOverflow is returned when the binary64 product is not finite."""
    ...
    if not (_cott_contract_condition((((record).price >= 0)), "curriculum.stock_record.value_record", "requires:1")):
    ...
    if not (_cott_contract_condition((((record).shares >= 0)), "curriculum.stock_record.value_record", "requires:2")):
    ...
    def _cott_match_ensures_3() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            ...
            return (_cott_contract_condition(((value >= 0)), "curriculum.stock_record.value_record", "ensures:3"))
...
NegativePrice in source order. A valid record is valued by value_record."""
    ...
    if type(_result) is Err and type(_result.error) is StockRecordError_NonFinitePrice:
        _cott_contract_condition(True, "curriculum.stock_record.value_stock_record", "error:4")
    if type(_result) is Err and type(_result.error) is StockRecordError_ValuationOverflow:
    ...
    def _cott_match_ensures_1() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            value = _cott_match_value.value
            return (_cott_contract_condition(((value >= 0)), "curriculum.stock_record.value_stock_record", "ensures:1"))
