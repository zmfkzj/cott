...
async def wrap_scalar_json(key: str, value: str) -> JsonValue:
    ...
    try:
        ...
        if _error.span is None:
            _error.span = {"end_byte":278,"end_column":1,"end_line":14,"start_byte":110,"start_column":1,"start_line":7}
        raise
    except SystemExit as _error:
        raise CottContractViolation("implementation raised SystemExit", symbol="curriculum.json_transform.wrap_scalar_json", phase="implementation-call", span={"end_byte":278,"end_column":1,"end_line":14,"start_byte":110,"start_column":1,"start_line":7}, expected="ordinary return or declared Never process.exit", actual="SystemExit") from _error
...
def extract_string_field(payload: JsonValue, field: str) -> Result[str, JsonTransformError]:
    ...
    try:
        ...
        if _error.span is None:
            _error.span = {"end_byte":467,"end_column":1,"end_line":20,"start_byte":278,"start_column":1,"start_line":14}
        raise
    except SystemExit as _error:
        raise CottContractViolation("implementation raised SystemExit", symbol="curriculum.json_transform.extract_string_field", phase="implementation-call", span={"end_byte":467,"end_column":1,"end_line":20,"start_byte":278,"start_column":1,"start_line":14}, expected="ordinary return or declared Never process.exit", actual="SystemExit") from _error
    except Exception as _error:
