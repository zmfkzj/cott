...
The response message is always exactly `Hello World`."""
    try:
        ...
        if _error.span is None:
            _error.span = {"end_byte":324,"end_column":1,"end_line":15,"start_byte":75,"start_column":1,"start_line":6}
        raise
    except SystemExit as _error:
        raise CottContractViolation("implementation raised SystemExit", symbol="integrations.fastapi_hello.read_root", phase="implementation-call", span={"end_byte":324,"end_column":1,"end_line":15,"start_byte":75,"start_column":1,"start_line":6}, expected="ordinary return or declared Never process.exit", actual="SystemExit") from _error
    ...
    if not (((_result).message == "Hello World")):
        raise CottContractViolation("ensures clause failed", symbol="integrations.fastapi_hello.read_root", clause="ensures:1", phase="ensures", span={"end_byte":307,"end_column":44,"end_line":12,"start_byte":268,"start_column":5,"start_line":12}, expected="true", actual="false")
    return _result
