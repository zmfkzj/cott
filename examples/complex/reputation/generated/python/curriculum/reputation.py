...
reject the first event that would overflow I32 or make the score negative."""
    ...
    def _cott_match_ensures_1() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            reputation = _cott_match_value.value
    ...
    def _cott_match_ensures_2() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            reputation = _cott_match_value.value
            return (((reputation).value <= 2147483647))
        return True
    ...
    _result = _cott_wrap_async_protocol(_result, Result[Reputation, ReputationError], path="$.return", validator=_cott_validate_abi)
    return _result
