...
def validate_payload(data: InputPayload) -> Result[InputPayload, BarError]:
    ...
    if _expected_error_clause is not None:
        _cott_contract_condition(True, "foo.bar.validate_payload", _expected_error_clause)
    def _cott_match_ensures_1() -> bool:
        _cott_match_value = _result
        if type(_cott_match_value) is Ok and True:
            validated = _cott_match_value.value
            return (_cott_contract_condition((((validated).data == (data).data)), "foo.bar.validate_payload", "ensures:1"))
    ...
    def _cott_match_ensures_2() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            validated = _cott_match_value.value
            return (_cott_contract_condition(((((validated).declared_size).value == ((data).declared_size).value)), "foo.bar.validate_payload", "ensures:2"))
    ...
    def _cott_match_ensures_3() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            validated = _cott_match_value.value
            return (_cott_contract_condition((((validated).format == (data).format)), "foo.bar.validate_payload", "ensures:3"))
...
def process_payload_bytes(data: bytes, options: BarOptions) -> Result[bytes, BarError]:
    ...
    def _cott_match_ensures_1() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            ...
            return (_cott_contract_condition(((processed == data)), "foo.bar.process_payload_bytes", "ensures:1"))
...
order, propagating validation and processing errors unchanged."""
    ...
    def _cott_match_ensures_1() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            ...
            return (_cott_contract_condition((((output).data == (data).data)), "foo.bar.process_bar", "ensures:1"))
    ...
    def _cott_match_ensures_2() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            output = _cott_match_value.value
            return (_cott_contract_condition(((((output).source_size).value == ((data).declared_size).value)), "foo.bar.process_bar", "ensures:2"))
    ...
    def _cott_match_ensures_3() -> bool:
        ...
        if type(_cott_match_value) is Ok and True:
            output = _cott_match_value.value
            return (_cott_contract_condition((((output).format == (data).format)), "foo.bar.process_bar", "ensures:3"))
